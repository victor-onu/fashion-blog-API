package com.victor.fashionblog.errorhandler;
...
//        ApiError ar = new ApiError(HttpStatus.BAD_REQUEST);
//        ar.addValidationError(mx.getBindingResult().getAllErrors());
//        ar.setError("Validation Error");
//        return buildResponseEntity(ar);
//    }
//
//    private ResponseEntity<Object> buildResponseEntity(ApiError apiResponse) {
...
//    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
            ...
            HttpStatus status,
            WebRequest request) {
        ApiError<Object> apiError = new ApiError<>(HttpStatus.BAD_REQUEST);
    ...
    protected ResponseEntity<Object> handleEntityNotFound(
        ...
        ApiError<Object> apiError = new ApiError<>(HttpStatus.NOT_FOUND);
...
//        log.info("{} to {}", servletWebRequest.getHttpMethod(), servletWebRequest.getRequest().getServletPath());
   ...
   @ExceptionHandler(CustomException.class)
    public ResponseEntity<Object> handleCustomException(CustomException ce) {
        ApiError<Object> ar = new ApiError<>(ce.getStatus());
    ...
    private ResponseEntity<Object> buildResponseEntity(ApiError<Object> apiError) {
